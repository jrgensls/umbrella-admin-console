...
const mainMenuItems: MenuItem[] = [
  ...
  { id: 'orders', label: 'Orders', icon: 'https://cdn.builder.io/api/v1/image/assets/47ad3a508fb640478c91bdeee233bd4b/edfbec5d568ce6fc26b2c0e50df6c8b0053e87d2?placeholderIfAbsent=true', href: '/orders' },
];
